...
// src/common/event-handlers/Events.ts
var EventHandlers;
var init_Events = __esm({
  "src/common/event-handlers/Events.ts"() {
    EventHandlers = {
...
// <stdin>
var modules = { "src/main/main.ts--default": (init_main(), __toCommonJS(main_exports))["default"] };
var commandId = true ? "src/main/main.ts--default" : figma.command;
modules[commandId]();
