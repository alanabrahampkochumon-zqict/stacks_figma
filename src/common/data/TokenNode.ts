 ...
 */
export class ValueNode<K extends ExtendedTokenType> extends TokenNode {
    readonly type: K;
    value: TokenTypeMap[K] // TODO: Update to use a typesafe mapping
    __identifier = JSON_IDENTIFIERS.VALUE_NODE

    /**
     * Instantiate a Concrete TokenNode (ValueNode).
     *
     * @param type  The type of value node. Acceptable types are {@link ExtendedToken}.
     * @param name  The name of the value node.
     * @param value The absolute value of the node, like "#fff".
     * @param id    The unique identifier of the GroupNode. Generated by default.
     */
    constructor(type: K, name: string, value: TokenTypeMap[K], id: string = v4()) {
        super(name, id)
        this.type= type
        this.value = value
    }
